...
export const toiletMarker = () => `
  <svg height="80%" class="hover:drop-shadow-markerShadow MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
...
export const wristBandMarker = () => `
  <svg height="80%" lass="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
...
export const prideMarker = () => `
  <svg height="80%" fill="url('#prideColor')" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
...
<svg height="80%" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24">
...
export const prideParadeMarker = () => `
<svg height="60%" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
