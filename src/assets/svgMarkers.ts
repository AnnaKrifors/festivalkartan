export const markerLabel = (title: string) =>
  `<div class="marker-label absolute left-1/2 transform -translate-x-1/2 -translate-y-full -top-1 text-center text-sm whitespace-nowrap bg-slate-100 p-1 border-2 border-[#003E4A] rounded ">${title}</div>`;
export const toiletMarker = () => `
