const markerLabel = (title: string) => {
  return `<div class="marker-label absolute left-1/2 transform -translate-x-1/2 -translate-y-full -top-1 text-center text-sm whitespace-nowrap bg-slate-100 p-1 border-2 border-[#003E4A] rounded ">${title}</div>`;
};

export const toiletMarker = (title: string) => `
  ${markerLabel(title)}
  <div class="marker-container hover:drop-shadow-markerShadow bg-slate-50 rounded-full flex justify-center items-center">
  <svg height="80%" class="hover:drop-shadow-markerShadow MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="WcIcon">
...
export const wristBandMarker = (title: string) => `
  ${markerLabel(title)}
  <div class="marker-container hover:drop-shadow-markerShadow bg-slate-50 rounded-full flex justify-center items-center">
  <svg height="80%" lass="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="LocalActivityOutlinedIcon">
...
export const prideMarker = (title: string) => `
  ${markerLabel(title)}
  <div class="marker-container hover:drop-shadow-markerShadow bg-slate-50 rounded-full flex justify-center items-center">
  <svg height="80%" fill="url('#prideColor')" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="LooksIcon">
  ...
  `;
export const entranceMarker = (title: string) => `
${markerLabel(title)}
<div class="marker-container hover:drop-shadow-markerShadow bg-slate-50 rounded-full flex justify-center items-center">
<svg height="80%" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="ExitToAppIcon">
...
export const sceneAreasMarker = (title: string) => `
${markerLabel(title)}
<div class="marker-container hover:drop-shadow-markerShadow bg-slate-50 rounded-full flex justify-center items-center">
<svg height="80%" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="StadiumOutlinedIcon">
...
export const marketMarker = (title: string) => `
${markerLabel(title)}
<div class="marker-container hover:drop-shadow-markerShadow bg-slate-50 rounded-full flex justify-center items-center">
<svg height="80%" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="StorefrontIcon">
...
export const waterMarker = (title: string) => `
${markerLabel(title)}
<div class="marker-container hover:drop-shadow-markerShadow bg-slate-50 rounded-full flex justify-center items-center">
<svg height="80%"class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="WaterDropOutlinedIcon">
...
export const redcrossMarker = (title: string) => `
${markerLabel(title)}
<div class="marker-container hover:drop-shadow-markerShadow bg-slate-50 rounded-full flex justify-center items-center">
<svg height="80%" class="hover:drop-shadow-markerShadow" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const funfairMarker = (title: string) => `
${markerLabel(title)}
<div class="marker-container hover:drop-shadow-markerShadow bg-slate-50 rounded-full flex justify-center items-center">
<svg height="80%" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="AttractionsOutlinedIcon">
...
export const safetytentMarker = (title: string) => `
${markerLabel(title)}
<div class="marker-container hover:drop-shadow-markerShadow bg-slate-50 rounded-full flex justify-center items-center">
<svg height="80%" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="VolunteerActivismOutlinedIcon">
...
export const defaultMarker = (title: string) => `
  ${markerLabel(title)}
<svg
  class="hover:drop-shadow-markerShadow"
  viewBox="29 19 56 69"
  fill="none"
